const images = {
  menuIcon: require('../images/icons/menu-button.png'),
  searchIcon: require('../images/icons/searching-magnifying-glass.png'),
  sortIcon: require('../images/icons/sort-button-with-three-lines.png'),
